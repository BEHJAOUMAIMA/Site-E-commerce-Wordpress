 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Oumaima's plugin
 * Plugin URI:        https://oumaima.me
 * Description:       this plugin is for adding a contact form
 * Version:           1.0.0
 * Requires at least: 5.2
 * Requires PHP:      7.2
 * Author:            Oumaima
 * Author URI:        https://oumaima.me
 ...
 */
 ...
 class oumaimaPlugin 
 {
    ...
    public function form(){
        ...
        $content .=  '<label for="NameUser" class="form-label">Nom du visiteur</label>';
        ...
        $content .='<div class="mb-3">';
        $content .=  '<label for="Subject" class="form-label">Sujet</label>';
        ...
        $content .='<div class="mb-3">';
        $content .=  '<label for="Message" class="form-label">Message</label>';
 ...
 $oumaimaPlugin = new oumaimaPlugin();


//  activation
register_activation_hook(
	__FILE__,
	[$oumaimaPlugin,'activation']
);
...
register_uninstall_hook(
	__FILE__,
    [$oumaimaPlugin,'uninstallation']
);

add_shortcode('oumaimaForm',[$oumaimaPlugin,'form']);
